    ...
    def start_receiving(self):
        ...
        while True:
            ...
            if len(best_bpdu_list):
                ...
                if self.rootPort_ID is None or not len(self.ports[self.rootPort_ID].BPDU_list) or best_bpdu.BPDU_list[0].is_incoming_BPDU_better(self.ports[self.rootPort_ID]):
